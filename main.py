...
# app = FastAPI(title="MetaSum POS AI Assistant")  # ✅ Sirf ek baar
...
#         raise HTTPException(status_code=500, detail="Groq SDK not installed.") from exc
...
#         return ChatResponse(
#             reply="We're sorry, the chatbot is busy. Contact: +92 317 4088510",
#             status="rate_limit"
#         )
